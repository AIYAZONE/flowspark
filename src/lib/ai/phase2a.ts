...
import { deriveFallbackReviewItems } from './reviewFallback';
import type { ReviewCandidates } from './reviewFallback';
import type {
	GoalBriefInput,
...
export type { ReviewCandidates } from './reviewFallback'
export { deriveFallbackReviewItems } from './reviewFallback'
