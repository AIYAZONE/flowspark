...
exports.ConvertGoalEntryToActionDialog = void 0;
...
function ConvertGoalEntryToActionDialog(_a) {
    var entry = _a.entry, goalId = _a.goalId, dict = _a.dict, startDefault = _a.startDefault, endDefault = _a.endDefault, trigger = _a.trigger, onSuccess = _a.onSuccess;
    ...
    var plainEntryTitle = utils_1.stripHtmlToPlainText(entry.content);
    var _f = react_1.useState(plainEntryTitle), title = _f[0], setTitle = _f[1];
    var _g = react_1.useState(entry.note || ''), description = _g[0], setDescription = _g[1];
    var _h = react_1.useState('core'), type = _h[0], setType = _h[1];
    var _j = react_1.useState('medium'), priority = _j[0], setPriority = _j[1];
                ...
                startTransition(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, actions_1.convertGoalEntryToAction(formData)];
                            case 1:
                                _a.sent();
                                setOpen(false);
            ...
            React.createElement("div", { className: utils_1.cn('flex flex-col', isDesktopFullscreen ? 'h-full' : 'h-full md:max-h-[90dvh]') },
                React.createElement(dialog_1.DialogHeader, { className: "border-b border-border/60 px-4 pb-3 pt-4 text-left md:px-6 md:pb-4 md:pt-6" },
                    React.createElement("div", { className: "flex items-start justify-between gap-3" },
                        React.createElement(dialog_1.DialogTitle, { className: "min-w-0 flex-1 text-left leading-snug" }, dict.goals.detail.convertToAction),
                ...
                React.createElement("form", { action: handleSubmit, className: "flex min-h-0 flex-1 flex-col" },
                    React.createElement("input", { type: "hidden", name: "entry_id", value: entry.id }),
                    ...
                    React.createElement("div", { className: "min-h-0 flex-1 space-y-5 overflow-y-auto px-4 py-4 md:px-6", style: { paddingBottom: keyboardInset > 0 ? Math.max(16, keyboardInset * 0.35) : undefined } },
                        React.createElement("div", { className: "space-y-2" },
                            React.createElement(label_1.Label, { htmlFor: "title-" + entry.id }, dict.inbox.actionTitleLabel),
                            React.createElement(input_1.Input, { ref: titleRef, id: "title-" + entry.id, name: "title", value: title, onChange: function (e) { return setTitle(e.target.value); }, required: true })),
                        React.createElement("div", { className: "space-y-2" },
                            React.createElement(label_1.Label, { htmlFor: "desc-" + entry.id }, dict.inbox.actionDescLabel),
                            React.createElement(textarea_1.Textarea, { id: "desc-" + entry.id, name: "description", value: description, onChange: function (e) { return setDescription(e.target.value); }, rows: 8, className: "min-h-[28dvh] md:min-h-[220px]" })),
                    ...
                    React.createElement("div", { className: "border-t border-border/60 bg-background/95 px-4 py-3 backdrop-blur md:bg-background/95 md:px-6 md:py-4", style: { paddingBottom: open && keyboardInset > 0 ? "calc(env(safe-area-inset-bottom) + " + keyboardInset + "px)" : undefined } },
                        React.createElement("div", { className: "flex items-center justify-end gap-2" },
                            ...
                            React.createElement(button_1.Button, { type: "submit", disabled: isPending || !title.trim() }, isPending ? (React.createElement(React.Fragment, null,
                                React.createElement(loading_spinner_1.LoadingSpinner, { className: "mr-2 h-4 w-4 text-current" }),
                                dict.common.saving)) : (dict.goals.detail.convertToAction)))))))));
}
exports.ConvertGoalEntryToActionDialog = ConvertGoalEntryToActionDialog;
