...
exports.EditGoalEntryDialog = void 0;
...
function EditGoalEntryDialog(_a) {
    var entry = _a.entry, goalId = _a.goalId, dict = _a.dict, trigger = _a.trigger, onSuccess = _a.onSuccess;
    ...
    var _f = react_1.useState(entry.content), content = _f[0], setContent = _f[1];
    var _g = react_1.useState(entry.note || ''), note = _g[0], setNote = _g[1];
                ...
                startTransition(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, actions_1.updateGoalEntry(formData)];
                            case 1:
                                _a.sent();
                                setOpen(false);
    ...
    var title = entry.kind === 'inspiration' ? dict.goals.detail.editInspiration : dict.goals.detail.editJourney;
    var contentPlaceholder = entry.kind === 'inspiration'
        ? dict.goals.detail.inspirationContentPlaceholder
        : dict.goals.detail.journeyContentPlaceholder;
    var notePlaceholder = entry.kind === 'inspiration'
                ...
                React.createElement("form", { action: handleSubmit, className: "flex min-h-0 flex-1 flex-col" },
                    ...
                    React.createElement("div", { className: "min-h-0 flex-1 space-y-4 overflow-y-auto px-4 py-4 md:px-6", style: { paddingBottom: keyboardInset > 0 ? Math.max(16, keyboardInset * 0.35) : undefined } },
                        React.createElement("div", { className: "space-y-2" },
                            React.createElement(label_1.Label, { htmlFor: "content-edit-" + entry.id }, dict.goals.detail.entryContentLabel),
                            React.createElement(BasicRichTextEditor_1.BasicRichTextEditor, { ref: contentRef, id: "content-edit-" + entry.id, name: "content", value: content, onChange: setContent, placeholder: contentPlaceholder, minHeightClassName: entry.kind === 'journey' ? 'min-h-[180px] md:min-h-[220px]' : 'min-h-[160px] md:min-h-[200px]' })),
                        React.createElement("div", { className: "space-y-2" },
                            React.createElement(label_1.Label, { htmlFor: "note-edit-" + entry.id }, dict.quickCapture.noteLabel),
                            React.createElement(textarea_1.Textarea, { id: "note-edit-" + entry.id, name: "note", value: note, onChange: function (e) { return setNote(e.target.value); }, placeholder: notePlaceholder, rows: entry.kind === 'journey' ? 10 : 6, className: entry.kind === 'journey' ? 'min-h-[38dvh] md:min-h-[320px]' : 'min-h-[28dvh] md:min-h-[240px]' })),
...
exports.EditGoalEntryDialog = EditGoalEntryDialog;
