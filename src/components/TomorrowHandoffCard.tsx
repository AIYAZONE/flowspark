...
export function TomorrowHandoffCard(props: {
  ...
  return (
    <div className={cn(
      'rounded-3xl border border-primary/15 bg-linear-to-br from-primary/10 via-background to-card p-5 shadow-sm shadow-primary/10',
      props.className
    )}>
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-start gap-3">
          <div className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-primary/15 bg-primary/12 text-primary">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-3 rounded-2xl border border-border/50 bg-background/80 px-4 py-3 text-sm">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-full bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground shadow-sm shadow-primary/20 transition-colors hover:bg-primary/90"
        >
          <span>{cta}</span>
